		...
		<form method="POST" action="<?php echo base_url('admin/data_customer/update_customer_aksi') ?>">
			...
			<div class="form-group">
				...
				<select class="form-control" name="role_id">
					<option value="1" <?php if ($cs->role_id == '1')
						echo ' selected="selected"'; ?>>Admin</option>
					<option value="2" <?php if ($cs->role_id == '2')
						echo ' selected="selected"'; ?>>Customer Rental</option>
					<option value="3" <?php if ($cs->role_id == '3')
						echo ' selected="selected"'; ?>>Pemilik Rental</option>
				</select>
			</div>

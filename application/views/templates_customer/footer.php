			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6">
					<div class="single-footer-widget">
						...
						<div class="widget-body">
							...
							<p>Cardoor adalah Pintu penghubung antara penyedia rental dengan customer. Sebuah
								marketplace untuk penyedia rental dan customer untuk saling terhubung.</p>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-6 col-md-6">
					<div class="single-footer-widget">
						<h2>Hubungi Kami</h2>
						<div class="widget-body">
							<p>Hubungi kami untuk mengetahui lebih banyak. Dapatkan layanan terbaik dan prioritas dari
								kami, Cardoor.</p>
